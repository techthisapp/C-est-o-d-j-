...
## Réglages Contenu : ordre calé sur l'affichage, ligne maître distinguée v147 (livré)
- DEMANDES : (1) ordonner les réglages de contenu dans le même sens que l'affichage sur l'accueil (la capsule en dernier) ; (2) mieux distinguer la ligne maître « Afficher le Rendez-vous du jour » de ses sous-réglages, dans la section Contenu.
